...
const features = [
  {
    title: "Design Your Own Challenges",
    description: "Easily create personalized challenges with flexible timeframes.",
    imageKey: "add-new-challenge.png",
  },
  {
    title: "Explore All Challenges",
    description:
      "Gain access to a variety of challenges to push yourself and build lasting habits.",
    imageKey: "total-challenges.png",
  },
  {
    title: "Monitor Your Progress",
    description:
      "Track key stats like daily streaks, global rankings, and see your growth over time.",
          ...
          <>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              >
                <View style={$header}>
                  <SmartImage
                    imgKey="boarding1.png"
                    width={100}
                    height={100}
                    style={{ marginBottom: 24 }}
                  />
                  <Text style={themed($title)} size="lg" weight="semiBold">
                    Get Challengli Pro
                  </Text>
                  <Text style={themed($subtitle)} size="sm" weight="medium">
                    Your Next Step to Better Habits
                  </Text>
                </View>
                ...
                >
                  {currentOffering.monthly && (
                    <TouchableOpacity
                      ...
                      style={[themed($common), themed($monthly)]}
                    >
                      <View
                        style={{
                          flexDirection: "row",
                  ...
                  {currentOffering.annual && (
                    <TouchableOpacity
                      ...
                      style={[themed($common), themed($annual)]}
                    >
                      <View
                        style={{
                          flexDirection: "row",
                      ...
                      >
                        ...
                        <Text weight="semiBold">Annual</Text>
                      </View>
                      <View>
                        <Text
                          style={{
                ...
                <View style={themed($featuresContainer)}>
                  {features.map((feature, index) => (
                    ...
                    >
                      ...
                      >
                        <Text style={themed($title)} size="xs" weight="semiBold">
                          {feature.title}
                        </Text>
                        <Text style={themed($subtitle)} size="xxs" weight="medium">
                          {feature.description}
                        </Text>
                      </View>
                    </View>
